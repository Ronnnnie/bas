...
<script type="text/javascript"
	src="${CONTEXT_PATH}/js/app/bonusDetail.js"></script>
</head>
<body>
<div class="easyui-layout" fit="true" >
 ...
 <div style="height:10px;width:100%"></div>
    <form id="searchColums">       
		...
		<input type="text" id="operateuserid" name="operateuserid"  style="width: 140px"/>
		</span>
		<span style="display:-moz-inline-box;display:inline-block;">
		<span style="display:-moz-inline-box;display:inline-block;width: 100px;text-align:right;" title="合同号">合同号：</span>	
		<input type="text" id="serialno" name="serialno" style="width: 80px"/>
		</span>
		<span style="display:-moz-inline-box;display:inline-block;">
 ...
 <div data-options="region:'center'">
	 <div id="bonusDetail" style="height: 100%"></div>
 </div>
</div>
</body>
</html>