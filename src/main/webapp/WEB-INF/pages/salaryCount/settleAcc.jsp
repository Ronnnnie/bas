...
<script type="text/javascript" src="${CONTEXT_PATH}/js/app/salarySettleAcc.js"></script>
</head>
<body>
	...
	<div data-options="region:'north'" title=" " style="width:100%;height: 15%;"> 
		<form>
			<div style="width:90%;margin: 5px;">
				...
				<label>起始时间(YYYYMM)：</label>
				<input id="searchStartCountDate" type="text" name="startCountDate" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" maxlength="6">
				
				<label>结束时间(YYYYMM)：</label>
				<input id="searchEndCountDate" type="text" name="endCountDate" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" maxlength="6">
