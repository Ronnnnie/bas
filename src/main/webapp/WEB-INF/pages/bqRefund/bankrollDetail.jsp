		   		...
		   		<tr>
		   			<td>
					    ...
					    <div id="tb" style="margin-left:20px">
							...
							<a href="http://localhost:8080/bas/bqRefundServer/exportExcel.do" class="easyui-linkbutton" data-options="iconCls:'icon-save',plain:true">模板导出</a>
...
<script type="text/javascript">
	...
	function payConfirmSubmit() {
		$('#payConfirmForm').form('submit', {
			url : contextPath + '/bqRefundServer/payConfirm.do',
			success : function(data) {
			...
			if (fileName == "") {
				...
				if (d1 == ".xls" || d1 == ".xlsx") {
					...
					$("#uploadCntractExcelFrm").form("submit", {
						url : contextPath + '/bqRefundServer/importContract.do',
						onSubmit : function() {
						},
						success : function(result) {
							...
							if(obj.success){
								...
								$.messager.confirm('操作提示','请仔细核对数据无误后点击确定再次导入!',function(r){   
								    if (r){
								    	$.ajax({  
								    		url : contextPath + '/bqRefundServer/importContractSave.do',
								    	    type: "POST",  
								    	    success: function (data) {  
