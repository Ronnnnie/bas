...
<!-- 数据网格 -->
	<div class="easyui-layout" data-options="fit:true" style="width:100%;height:100%">
		<div data-options="region:'north'" title="" style="width:100%;height: 16%;"> 
			<form id="queryForm">
			...
			<div style="width: 90%; margin-top:7px;margin-left:20px">
				...
				<a style="margin-left: 30px;height:23px" id="button-search" href="javascript:;"	onclick="query()" class="easyui-linkbutton"	data-options="iconCls:'icon-search'">搜索</a>
				<a style="margin-left: 26px;height:23px" id="button-search" href="javascript:;"	onclick="clearForm('queryForm')" class="easyui-linkbutton"	data-options="iconCls:'icon-reload'">重置</a>
			</div>
		</form>
	</div>
		...
		<div id="tb" style="margin-left：100px">	
		  ...
		  <table id="clearanceCertificateGrid" class="easyui-datagrid" title="放款表业务汇总" style="width:100%;height:410px;"
			data-options="
					id:'dg-dopts',
					rownumbers:true,
					loadMsg:'数据加载中,请稍等',
