...
<div class="easyui-layout" data-options="fit:true"
	...
	<div data-options="region:'north'" title=""
		...
		<div style="width: 90%; margin: 5px;">
			...
			<a style="margin-left:58px;margin-top:3px;height:25px" id="button-search" href="javascript:;"	onclick="query()" class="easyui-linkbutton"	data-options="iconCls:'icon-search'">搜索</a>
...
<script type="text/javascript">
	...
	function query() {
		...
		$.ajax({
			url : contextPath + "/businessLoanServer/queryBusinessDetails.do",
			type : "POST",
			data : {
				rows: 10,
				page:1,
	...
	function exportExcel(){
		$.messager.progress({ title: 'excel数据导出中', msg: '数据导出中...'});
		$.ajax({
			url : contextPath + "/businessLoanServer/excelExport.do",
			type : "POST",
			data : {
			},
