...
<!-- 数据网格 -->
	<div class="easyui-layout" data-options="fit:true" style="width:100%;height:98%">
		<div data-options="region:'north'" title="" style="width:100%;height: 72px;"> 
			...
			<label	style="margin-left: 20px">付款日期:</label>
				 ...
				 <input	id="endPayDate" type="text" class="easyui-datebox"	style="width: 100px"
						data-options="formatter:myformatter,parser:myparser" />
			<a style="margin-left:20px;height:23px" id="button-search" href="javascript:;"	onclick="query()" class="easyui-linkbutton"	data-options="iconCls:'icon-search'">搜索</a>
			<a style="margin-left:20px;height:23px" id="button-search" href="javascript:;"	onclick="clearForm('queryForm')" class="easyui-linkbutton"	data-options="iconCls:'icon-reload'">重置</a>
			</div>
			</form>
		</div>
		...
		<div id="tb" style="margin-left：100px">	
		  ...
		  <table id="clearanceCertificateGrid" class="easyui-datagrid" title="放款表资金明细" style="width:100%;height:410px;"
			data-options="
					id:'dg-dopts',
					rownumbers:true,
					loadMsg:'数据加载中,请稍等',
