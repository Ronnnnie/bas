...
<script type="text/javascript" src="${CONTEXT_PATH}/js/app/overdueUnGather.js" charset="utf-8"></script>
...
<div class="easyui-layout" data-options="fit:true"
	...
	<div data-options="region:'north'" title=""
		...
		<form id="queryForm">
		<div style="width: 98%; margin-top:5px;margin-left:20px">
			<label style="margin-left:0px">贷款子类型:</label>
				<select id="subProductType" name="subProductType" class="easyui-combobox" style="width: 130px;">
			...
			<label style="margin-left:10px">记账日期:</label>
				<input id="startInAccountDate" type="text" class="easyui-datebox" style="width:100px;margin-top:50px;"
			...
			<label style="margin-left:10px">业务模式:</label>
				<select id="businessModel" name="businessModel" class="easyui-combobox" style="width: 100px;">
					<option value="">---请选择---</option>
			...
			<label>城市:</label>
				<input id="city" name="city" type="text" class="easyui-textbox" style="width:100px;margin-top:50px;"/>
		...
		<div style="width: 98%; margin-top:7px;margin-left:20px">
			<label>资产所属方:</label>
			...
			<label style="margin-left:10px">保证方:</label>
				<select id="guaranteeParty" class="easyui-combobox" name="guaranteeParty" style="width: 130px;">
					<option value="">---请选择---</option>
					<option value="BQJR">佰仟金融</option>
					<option value="GZBC">贵州佰诚</option>
					<option value="RMBX">中国人民财产保险</option>
	...
	<div data-options="region:'center'" style="height:520px">
		...
		<table id="clearanceCertificateGrid"
			class="easyui-datagrid" title="未到期汇总表"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'payprinciPalamt'" formatter="thousandthFormatter">未到期本金</th>
					<th data-options="field:'payInteamt'" formatter="thousandthFormatter">未到期利息</th>
					<th data-options="field:'a2'" formatter="thousandthFormatter">未到期客户服务费</th>
					<th data-options="field:'a7'" formatter="thousandthFormatter">未到期账户管理费</th>
					<th data-options="field:'a12'" formatter="thousandthFormatter">未到期增值服务费</th>
					<th data-options="field:'a18'" formatter="thousandthFormatter">未到期实心还服务费</th>
					<th data-options="field:'a22'" formatter="thousandthFormatter">未到期佰保袋服务费</th>
