...
<script type="text/javascript" src="${CONTEXT_PATH}/js/app/overdueUnDetail.js" charset="utf-8"></script>
...
<div class="easyui-layout" data-options="fit:true"
	...
	<div data-options="region:'north'" title=""
		...
		<div style="margin-top:10px;margin-left:10px">
			<label style="margin-left: 10px">记账日期:</label>
				<input id="startInAccountDate" name="startInAccountDate" type="text" class="easyui-datebox" style="width:110px;" data-options="formatter:myformatter,parser:myparser" />至
				<input id="endInAccountDate" name="endInAccountDate" type="text" class="easyui-datebox"	style="width: 110px" data-options="formatter:myformatter,parser:myparser" />
			<label style="margin-left: 10px">合同号:</label> 
				<input id="serialNo" name="serialNo"  style="width: 120px" class="easyui-textbox" />
	...
	<div data-options="region:'center'" style="height:520px">
		...
		<table id="clearanceCertificateGrid"
			class="easyui-datagrid" title="未到期明细表"
