	...
	<div class="easyui-layout" data-options="fit:true" style="width:100%;height:98%">
		<div data-options="region:'north'" title="" style="width:256%;height: 110px;"> 
			...
			<div style="margin-top:10px;margin-left:10px">
				...
				<label style="margin-left: 21px">业务模式:</label>
			...
			<div style="margin-top:7px">
				<label style="margin-left: 20px">记账日期:</label>
			...
			<div style="margin-top:7px">
				<label style="margin-left: 20px">资产所属方:</label> 
		...
		<div id="tb" style="margin-left：100px">	
		  ...
		  <table id="currentExpiredSumGrid" class="easyui-datagrid" title="到期表汇总" style="width:100%;height:96%;"
			data-options="
					id:'inaccountdate',
					rownumbers:true,
					loadMsg:'数据加载中,请稍等',
			...
			<thead>
				...
				<th data-options="field:'inaccountdate'">记账期间</th>
