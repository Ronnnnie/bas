...
<script  type="text/javascript" src="${CONTEXT_PATH}/js/app/currentExpiredList.js" charset="utf-8"></script>
...
<!-- 数据网格 -->
	<div class="easyui-layout" data-options="fit:true" style="width:100%;height:98%">
		<div data-options="region:'north'" title="" style="width:256%;height: 60px;"> 
			...
			<div style="width:97%;margin-top:7px;margin-left:20px">
				<label>合同号:</label>
				<input class="easyui-textbox" name="serialno" id="searchSerialno" width="80px" class="easyui-validatebox" data-options="validType:'unnormal'"  maxlength="20"/>
				<label>记账日期:</label>
				...
				<label>资产所属方:</label> 
				<select id="assetbelong" class="easyui-combobox" name="assetbelong" style="width: 100px;">
		...
		<div id="tb" style="margin-left：100px">	
		   		...
		   		<tr>
		   			<td>
					    ...
					    <div id="tb" style="margin-left:20px">
					    	<a href="javascript:;" onClick = "openUpdateCurrentExpired()" class="easyui-linkbutton" data-options="iconCls:'icon-ok',plain:'true'">记账确认</a>
					    	<a href="javascript:;" onClick = "openCancelCurrentExpired()" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',plain:'true'">记账撤销</a>
		  ...
		  <table id="currentExpiredGrid" class="easyui-datagrid" title="到期表明细" style="width:100%;height:96%;"
			data-options="
					id:'serialno',
					rownumbers:true,
					loadMsg:'数据加载中,请稍等',
			...
			<thead>
				...
				<th data-options="field:'a2'" formatter="thousandthFormatter">应还客户服务费</th>
				<th data-options="field:'a7'" formatter="thousandthFormatter">应还账户管理费</th>
				<th data-options="field:'a12'" formatter="thousandthFormatter">应还增值服务费</th>
				<th data-options="field:'a18'" formatter="thousandthFormatter">应还随心还服务费</th>
				<th data-options="field:'a22'" formatter="thousandthFormatter">应还佰保袋服务费</th>
	...
	<div id="updateCurrentExpiredWin" style="width: 350px;text-align:center;display: none;padding: 15px;" >
		<form id="updateCurrentExpiredFrm" method="post">
		    ...
		    <div style="padding:5px;text-align:center;">  
	            <a href="javascript:;" onClick = "updateCurrentExpired()" class="easyui-linkbutton" data-options="iconCls:'icon-ok'">记账</a>
	            <a href="javascript:;" onClick = "closeWin('updateCurrentExpiredWin')" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'">取消</a>  
	     	</div>  
		</form>
	</div> 


	<div id="cancelCurrentExpiredWin" style="width: 350px;text-align:center;display: none;padding: 15px;" >
		<form id="cancelCurrentExpiredFrm" method="post">
		    ...
		    <div style="padding:5px;text-align:center;">  
	            <a href="javascript:;" onClick = "cancelCurrentExpired()" class="easyui-linkbutton" data-options="iconCls:'icon-ok'">撤销</a>
	            <a href="javascript:;" onClick = "closeWin('cancelCurrentExpiredWin')" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'">取消</a>  
	     	</div>  
		</form>
	</div> 
	
<div id="currentExpiredMultipleDlg" data-options="iconCls:'icon-save'"
	style="width: 600px; height: 400px; padding: 10px">
	<form id="currentExpiredMultipleForm" method="post">
		<table>
			<tbody>
				<tr>
		...
		<div id="EditTop" style="margin-top:10px">
			<a style="margin-left:60px" href="javascript:;" onClick = "currentExpiredMultipleUpdate()" class="easyui-linkbutton" data-options="iconCls:'icon-ok'">记账</a>
			<a href="javascript:;" onClick = "currentExpiredMultipleCancel()" class="easyui-linkbutton" data-options="iconCls:'icon-ok'">撤销</a>
	        <a href="javascript:;" onClick = "closeWin('currentExpiredMultipleDlg')" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'">取消</a>  
		</div>
	</form>
</div>
