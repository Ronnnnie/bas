...
<script type="text/javascript" src="${CONTEXT_PATH}/js/app/clientRepaymentDetail.js?version=20170414" charset="utf-8"></script>
...
<div class="easyui-layout" data-options="fit:true"
	...
	<div data-options="region:'north'" title=""
		...
		<div style="width: 98%; margin-top:8px">
			<label style="margin-left:15px">记账日期:</label>
			...
			<label style="margin-left:20px">合同号:</label> 
				<input class="easyui-textbox" style="width:100px" id="serialNo" name="serialNo" />
			<label style="margin-left:20px">产品子类型:</label> 
				 <select id="subProductType" name="subProductType" class="easyui-combobox textbox combobox-f combo-f textbox-f"  style="width: 115px;">
			...
			<label	style="margin-left: 15px">审核日期:</label>
			 	 <input	id="startApproveTime" name="startApproveTime" type="text" class="easyui-datebox" style="width: 100px"
						data-options="formatter:myformatter,parser:myparser"> 至
				 <input	id="endApproveTime" name="endApproveTime" type="text" class="easyui-datebox"	style="width: 100px"
						data-options="formatter:myformatter,parser:myparser" />
		</div>
		<div style="margin-top:10px">
			<label	style="margin-left: 15px">实还日期:</label>
			...
			<label style="margin-left:32px">审核状态:</label> 
			...
			<label	style="margin-left: 30px">注册日期:</label>
	...
	<div data-options="region:'center'" style="height:500px">
		<div id="tb">
			<table	style="width: 100%; height: 15px; border-left: none; border-bottom: none; border-right: none;">
				<tr>
					<td>
						<!-- 按钮 start -->
						<div id="tb">
						    <a href="#"	class="easyui-linkbutton"	data-options="iconCls:'icon-ok',plain:'true'" onclick="contractApprove()" >审核</a>
						    <a href="#"	class="easyui-linkbutton"	data-options="iconCls:'icon-ok',plain:'true'" onclick="accountingMark()" >记账</a>
						    <a href="#"	class="easyui-linkbutton"	data-options="iconCls:'icon-cancel',plain:'true'" onclick="cancelAccountingMark()" >撤销</a>
		...
		<table id="clearanceCertificateGrid"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'productType'">产品分类</th>
					...
					<th data-options="field:'actualPayPrincipalAmt'" formatter="thousandthFormatter" width="120px">实还本金</th>
					<th data-options="field:'actualPayinteAmt'" formatter="thousandthFormatter" width="120px">实还利息</th>
		...
		<table id="orgInfoAddTable" style="margin:auto">
			<tbody style="font-size: 13">
				...
				<tr>
					...
					<td><input id="payType" name="payType" class="easyui-textbox" style="width:150px" data-options="editable:false"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input id="startKeepaccountsDate" name="startKeepaccountsDate" class="easyui-textbox" style="width:150px" data-options="editable:false"/>至
					<input id="endKeepaccountsDate" name="endKeepaccountsDate" class="easyui-textbox" style="width:150px" data-options="editable:false"/></td>
				</tr>
				
				<tr>
					<th style="text-align: right;">实还日期:</th>
					<td><input id="startActualPayDate" name="startActualPayDate" class="easyui-textbox" style="width:150px" data-options="editable:false"/>至
					<input id="endActualPayDate" name="endActualPayDate" class="easyui-textbox" style="width:150px" data-options="editable:false"/></td>
				</tr>
				
				<tr>
					<th style="text-align: right;">注册日期:</th>
					<td><input id="startRegistrationDate" name="startRegistrationDate" class="easyui-textbox" style="width:150px" data-options="editable:false"/>至
					<input id="endRegistrationDate" name="endRegistrationDate" class="easyui-textbox" style="width:150px" data-options="editable:false"/></td>
				</tr>
				...
				<tr style="line-left:100px;" >
					...
					<td>
						<select id="updateApproveStatus" name="updateApproveStatus" class="easyui-combobox textbox combobox-f combo-f textbox-f" data-options="editable:false"  style="width: 150px;" >
		...
		<table id="orgInfoAddTable" style="margin:auto">
			<tbody style="font-size: 13">
				...
				<tr>
					<th style="text-align: right;">还款类型:</th>
					<td>
						<select id="payType" name="payType" class="easyui-combobox textbox combobox-f combo-f textbox-f" data-options="editable:false" style="width:150px">
							<option value="1">正常还款</option>
	...
	<form id="onDBAccountingMarkForm" method="post">
		<table id="orgInfoAddTable" style="margin:auto">
			<tbody style="font-size: 13">
				...
				<tr style="line-height:15px;">
					<th style="text-align: right;">共计实还本金:</th>
					<td>
					<input id="actualPayPrincipalAmt" name="actualPayPrincipalAmt" style="width:150px" data-options="editable:false" type="hidden" />
					<input id="actualPayPrincipalAmtSum" name="actualPayPrincipalAmtSum" class="easyui-textbox" style="width:150px" data-options="editable:false,required:true"/></td>
				</tr>
				
				<tr style="line-height:15px;">
					<th style="text-align: right;">共计实还利息:</th>
					<td>
					<input id="actualPayinteAmt" name="actualPayinteAmt" style="width:150px" data-options="editable:false" type="hidden" />
					<input id="keepAccountsStatusSum" name="keepAccountsStatusSum" style="width:150px" data-options="editable:false" type="hidden" />
...
<div id="cancelAccountingMarkdlg" data-options="iconCls:'icon-save'"
	...
	<form id="cancelAccountingMarkForm" method="post">
		...
		<div id="EditTop" style="margin-top:15px">
			<a style="margin-left:100px" href="javascript:;" onClick = "cancelAccountingMarkSubmit('cancelAccountingMarkdlg','cancelAccountingMarkForm')" class="easyui-linkbutton" data-options="iconCls:'icon-ok'">确认撤销</a>
