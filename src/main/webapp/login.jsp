...
<div id="successLogin"></div>
  <div class="text_success">
   ...
   <span>登录成功!请稍后....</span>
	...
	<form action="login.do" method="post" id="fm1" >
		
			<div id="main">
				<div id="login">
					<div>
						用户名：
						<input type="text" id="username" name="username" title="用户名" value="" nullmsg="请输入用户名!"
						 style="width: 160px; height: 20px;" />
					</div>
					<div id="pswdiv">
						 &nbsp密码：
						<input type="password" id="password" name="password" title="密码" value="" nullmsg="请输入密码!"
						style="width: 160px; height: 20px;" />
					</div>
					<!-- <div id="codediv" >
